  ...
  private mapException(exception: unknown): {
    ...
    if (exception instanceof Prisma.PrismaClientInitializationError) {
      return {
        ...
        error: { code: exception.errorCode ?? 'INIT_ERROR' },
      };
    }
    ...
    switch (exception.code) {
      case 'P2002':
        return {
          ...
          error: { code: exception.code, fields: target ?? null },
        };
      ...
      case 'P2025':
        return {
          ...
          error: { code: exception.code, details: exception.meta ?? null },
        };
      ...
      case 'P2003':
        return {
          ...
          error: { code: exception.code, field: fieldName ?? null },
        };
      ...
      default:
        return {
          ...
          error: { code: exception.code, meta: exception.meta ?? null },
        };
    }
  }
}
